...
import ServicesOffered, { ServiceFilter } from '@shared/components/common/ServicesOffered';
...
export const AMBULANCE_SERVICES: ServiceFilter[] = [
  ...
  { id: 'private-ambulance', label: 'Private Ambulance', icon: 'mdi:ambulance' },
  { id: 'pharmacy', label: 'Pharmacy', icon: 'mdi:pill' },
  { id: 'diagnostic-lab', label: 'Diagnostic Lab', icon: 'mdi:microscope' },
  { id: 'emergency', label: '24/7 Emergency', icon: 'mdi:alert-circle' }
];
